...
<body>
	<main>
	<h1>Run Rotate Run</h1>
	<input id="radio1" type="radio" name="css-tabs" checked>
	<input id="radio2" type="radio" name="css-tabs">
	<input id="radio3" type="radio" name="css-tabs">
	<input id="radio4" type="radio" name="css-tabs">
	<div id="tabs">
		<label id="tab1" for="radio1">Abstract</label>
		<label id="tab2" for="radio2">Description</label>
		<label id="tab3" for="radio3">Rules</label>
		<label id="tab4" for="radio4">Managers</label>
		<label id="tab5" for="radio5">Location</label>
	</div>
	<div id="content">
		<section id="content1">
			<br>
