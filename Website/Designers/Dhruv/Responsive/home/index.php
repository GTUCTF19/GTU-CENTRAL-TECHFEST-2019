...
<body>
	...
	<section id="homepage">
		<div class="middle">
    		<div class="inner animated zoomIn delay-2s">
    			<h4 class="gtu">GTU Central TechFest'19</h4>
    			<p class="hostedby">
                    Hosted by Vishwakarma Government Engineering College
                </p>
    		</div>
	...
	<section id="overview">
		<div class="middle">
    		<div class="inner container animated zoomIn delay-2s"><br>
			<div class="row">
		        <div class="col-sm">
		          <h1 class="title-widget">When</h1>
		          <h5>28-29 March</h5>
		        </div>
		        <div class="col-sm">
		          <h1 class="title-widget">Where</h1>
		          <h5>At Vishwakarma Government Engineering College</h5>
		        </div>
		    </div>
		    <br><br>
		    <div class="row">
		      <div class="wow fadeInUp col-sm" data-wow-delay="0.6s">
		        <h1 class="title-widget">OverView</h1>
