...
if(isset($_POST['submit'])) 
{
    ...
    $ins_query = "insert into volunteer (name,phone) values ('$name','$phone')";
                        ...
                        <div class="login-form">
                            <form method="post">
								...
								<div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="phone" placeholder="Phone No" onkeypress="return isNumberKey(event)" pattern="[7-9]{1}[0-9]{9}">
                                </div>
