    ...
    <div class="page-wrapper">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            <a class="active js-arrow" href="#">
                                <i class="fas fa-tachometer-alt"></i>VOLUNTEER DETAILS</a>
                            </li>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
              <div class="container">
              <h3 style="text-align:center">REGISTRATION VOLUNTEER DETAILS</h3><br>
		...
		<th><center><font  size='4'>Volunteer Name</font></center></th>
        ...
        $disp=mysqli_query($conn,"select * from volunteer");
