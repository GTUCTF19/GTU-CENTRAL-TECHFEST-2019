...
<html lang="en">
    <head>
      <meta charset="utf-8">
      <title>Non-Technical Events | GTU CENTRAL TECHFEST'19</title>
      ...
      <main id="main">
        <section id="eventstwo" class="section-with-bg wow fadeInUp">
          <div class="container">
            ...
            <div class="row">
                <?php
                    $sql = 'SELECT e_name FROM `non_tech`';
                        ...
                        while($row = mysqli_fetch_assoc($result)) {  
                            echo '<div class="col-lg-4 col-md-6">';
                                echo '<div class="eventtwo" id="shadow">';
                                  ...
                                  echo '</div>';
                                  echo '<h3><a href="nontechdescription.php?e_name='.$row["e_name"].'"><center>' . $row["e_name"] . '</center></a></h3>';
                                echo '</div>';
                              echo '</div>';
                            $i=$i+1;  
                        }
