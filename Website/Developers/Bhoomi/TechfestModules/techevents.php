...
<html lang="en">
    <head>
      <meta charset="utf-8">
      <title>Technical Events | GTU CENTRAL TECHFEST'19</title>
                        ...
                        while($row = mysqli_fetch_assoc($result)) {  
                            echo '<div class="col-lg-3 col-md-6">';
                                echo '<div class="eventtwo" id="shadow">';
                                  ...
                                  echo '</div>';
                                  echo '<h3><a href="techdescription.php?e_name='.$row["e_name"].'"><center>' . $row["e_name"] . '</center></a></h3>';
                                echo '</div>';
                              echo '</div>';
                            $i=$i+1;  
                        }
